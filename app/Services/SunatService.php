...
class SunatService
{
    ...
    public function getSeeApi($company)
    {
        ...
        $api->setBuilderOptions([
            ...
            $company->production ? $company->client_secret : "test-HtY/M6QshYVpGItX2P0+Kw==" // Token
        )->setClaveSol(
            $company->ruc,
            $company->production ? $company->sol_user : 'MODDDATOS',
            $company->production ? $company->sol_pass : 'MODDDATOS'
    ...
    public function getHtmlReport($invoice)
    {
        ...
        return $htmlReport->render($invoice, $params);
    }
